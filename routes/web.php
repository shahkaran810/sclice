...
Route::group(['middleware' => ['auth', '2fa', 'isActive', 'translate', setting('email_verification', 'permission') ? 'verified' : 'web'], 'prefix' => 'user', 'as' => 'user.'], function () {
    ...
    Route::get('custom-plan', [InvestController::class, 'customPlan'])->name('custom-plan');
    Route::post('custom-plan-submit', [InvestController::class, 'submitCustomPlan'])->name('custom-plan-submit');
